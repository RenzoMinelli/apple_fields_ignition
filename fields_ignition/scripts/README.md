...
- **`graficas_con_ajuste.py`**:
  Analogo al archivo anterior, pero en este caso las gráficas generadas comparan los resultados de no utilizar ningun tipo de ajuste con utilizar un ajuste por coeficiente y un ajuste por modelo de regresión lineal.
  Además los mundos sobre los que se trabaja en este caso son 6, de la forma:
  3 mundos 5x1
  1 mundo 1x10
  1 mundo 5x3
  1 mundo 7x3
